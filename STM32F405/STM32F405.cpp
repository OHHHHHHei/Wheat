...
Motor can2_motor[CAN2_MOTOR_NUM] = {
	...
	//Motor(M2006, SPD, supply, ID7, PID(3.5f, 0.1f, 5.f, 0.f)),	//spd拨弹轮

	Motor(M2006, ACE, supply, ID7, PID(3.0f, 0.01f, 10.f),PID(0.5f, 0.01f, 2.f,0.f)),	//ace拨弹轮
...
int main(void)
{
	...
	// 功率上限可根据实际情况调整
	powerLimiter.Init(ctrl.chassis_motor, 40.0f, 0.17f, 1.08f, 3.3f);
